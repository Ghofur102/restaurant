        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"
                        class="text-center btn d-flex w-50 justify-content-center btn-outline-primary"
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"
                        ...
                        class="text-center btn d-flex w-50 justify-content-center btn-primary">DELETE</button>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="border-0 shadow-sm dropdown-menu dropdown-menu-right">
                            ...
                            <form action="{{ route('logout') }}" method="post">
                                ...
                                <button type="submit" class="dropdown-item"><i
                                        class="icofont icofont-circled-left"></i>
                                    Logout</button>
                            </form>
                        </div>
                    </li>
                        ...
                        <div class="p-0 border-0 shadow-sm dropdown-menu dropdown-cart-top dropdown-menu-right">
                            <div class="p-4 dropdown-cart-top-header">
                                <img class="mr-3 img-fluid" alt="osahan"
                                    src="{{ asset('frontend/img/cart.jpg') }}">
