                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="my-auto auth-content">
                                    <div class="text-center">
                                        <h5 class="mb-0">Register Client Page !</h5>
                                        <p class="mt-2 text-muted">Register to continue to Client Login.</p>
                                    </div>
                                    @if ($errors->any())
                                    ...
                                    @endif
                                    <form class="pt-2 mt-4" action="{{ route('client.register.submit') }}"
                                        method="POST">
                                        @csrf
                                        <div class="mb-3">
